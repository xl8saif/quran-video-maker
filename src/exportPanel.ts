...
export function createExportPanel(bindings:ExportPanelBindings):HTMLElement {
 ...
 select('Playback speed',String(bindings.options.playbackSpeed),[{value:'0.75',label:'0.75×'},{value:'1',label:'1×'},{value:'1.25',label:'1.25×'},{value:'1.5',label:'1.5×'},{value:'2',label:'2×'}],v=>bindings.onOptionsChange?.({...bindings.options,playbackSpeed:Number(v) as ExportPlaybackSpeed}))
